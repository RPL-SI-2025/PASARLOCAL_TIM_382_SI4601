<nav class="navbar navbar-expand-lg bg-white shadow-sm sticky-top" style="border-top-left-radius: 15px; border-top-right-radius: 15px; padding:24px 35px; min-height:88px; transition: all 0.3s ease;">
        ...
        <div class="d-flex align-items-center gap-4 w-100">
            ...
            <div class="collapse navbar-collapse justify-content-end ms-auto" id="navbarNav">
                <ul class="navbar-nav gap-2">
                    <li class="nav-item">
                        <a class="nav-link fw-semibold {{ Request::is('pedagang/manajemen-produk*') ? 'active' : '' }}" href="{{ route('pedagang.manajemen-produk.index') }}" style="border:2px solid #28a745; border-radius:8px; color:#28a745; padding:6px 18px;">
                            Manajemen Produk
                        </a>
                    </li>
                    <li class="nav-item">
