...
Route::get('/customer/search', [App\Http\Controllers\ProductController::class, 'search']);
Route::get('/customer/filter', [App\Http\Controllers\ProductController::class, 'filter']);
Route::get('/customer/product/{name}', [App\Http\Controllers\ProductController::class, 'show']);
